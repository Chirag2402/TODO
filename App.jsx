...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="container w-9/12 mx-auto my-8 rounded-xl p-5 bg-violet-100 min-h-[85vh]">
        <div className="addtodo ">
          ...
          <div className="flex justify-between items-center px-4">
            <input
              ...
              value={todo}
              type="text"
              class="w-10/12 p-2 bg-violet-200 border border-violet-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
            />
